    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextProcessButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txtTotalAmount.setText("Total Price = Rs" + String.valueOf(overallTotalPrice));//display total price on the top
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Congratulations, your final order has been shipped successfully. Soon you will received your order at your door.");
