...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        if (check.equals("settings"))
        {
            ...
            titleQuestions.setText("set Answers for the Security Questions");
        ...
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "set security questions sucessfully", Toast.LENGTH_SHORT).show();
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    if(dataSnapshot.exists())
                    {
                        ...
                        if(dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this, "answer one is wrong", Toast.LENGTH_SHORT).show();
                            }

                            else if(!ans2.equals(answer2))
                            {
                                Toast.makeText(ResetPasswordActivity.this, "answer two is wrong", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
