...
public class SellerMaintainProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyChangesBtn = findViewById(R.id.S_apply_changes_btn);
    ...
    private void deleteThisProduct() {
        ...
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Intent intent = new Intent(SellerMaintainProductActivity.this, SellerCategoryActivity.class);
                startActivity(intent);
                finish();

                Toast.makeText(SellerMaintainProductActivity.this, "The Product Is deleted successfully.", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        else if (pDescription.equals(""))
        {
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(SellerMaintainProductActivity.this, "Changes applied successfully.", Toast.LENGTH_SHORT).show();
