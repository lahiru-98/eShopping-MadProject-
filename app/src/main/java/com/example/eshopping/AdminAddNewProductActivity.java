...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    public static class SellerAddNewProductActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            AddNewProductButton = (Button) findViewById(R.id.S_add_new_product);
            InputProductImage = (ImageView) findViewById(R.id.S_select_product_image);
            InputProductName = (EditText) findViewById(R.id.S_product_name);
            InputProductDescription = (EditText) findViewById(R.id.S_product_description);
            InputProductPrice = (EditText) findViewById(R.id.S_product_price);
            loadingBar = new ProgressDialog(this);
